...
public class UploadField extends AbstractField implements Component.Focusable {
    ...
    public UploadField(String caption, Receiver uploadReceiver) {
        setCaption(caption);
    ...
    public static class FinishedEvent extends Component.Event {
         ...
         */
        public FinishedEvent(UploadField source, String filename, String MIMEType,
                long length) {
            super(source);
            type = MIMEType;
    ...
    public static class FailedEvent extends FinishedEvent {
         ...
         * @param exception
         */
        public FailedEvent(UploadField source, String filename, String MIMEType,
    ...
    public static class NoOutputStreamEvent extends FailedEvent {
         ...
         * @param length
         */
        public NoOutputStreamEvent(UploadField source, String filename,
    ...
    public static class NoInputStreamEvent extends FailedEvent {
         ...
         * @param length
         */
        public NoInputStreamEvent(UploadField source, String filename,
                String MIMEType, long length) {
            super(source, filename, MIMEType, length);
        }
    ...
    public static class SucceededEvent extends FinishedEvent {
         ...
         * @param length
         */
        public SucceededEvent(UploadField source, String filename, String MIMEType,
                long length) {
            super(source, filename, MIMEType, length);
        }
    ...
    public static class StartedEvent extends Component.Event {
         ...
         * @param length
         */
        public StartedEvent(UploadField source, String filename, String MIMEType,
                long contentLength) {
            super(source);
            this.filename = filename;
            type = MIMEType;
    ...
    protected void fireStarted(String filename, String MIMEType) {
        fireEvent(new UploadField.StartedEvent(this, filename, MIMEType,
                contentLength));
    }
    ...
    protected void fireNoInputStream(String filename, String MIMEType,
            long length) {
        fireEvent(new UploadField.NoInputStreamEvent(this, filename, MIMEType,
                length));
    }

    protected void fireNoOutputStream(String filename, String MIMEType,
            long length) {
        fireEvent(new UploadField.NoOutputStreamEvent(this, filename, MIMEType,
                length));
    }
	...
	public Class<?> getType() {
		return UploadFileOutputStream.class;
	};
}
