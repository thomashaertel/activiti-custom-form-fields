...
public class UploadField2 extends Upload implements Field, Property.ReadOnlyStatusChangeListener,
		Property.ReadOnlyStatusChangeNotifier, Action.ShortcutNotifier {

	private static final long serialVersionUID = -8717875256013421120L;
    ...
    public UploadField2(String caption, Receiver uploadReceiver) {
    ...
    protected void fireReadOnlyStatusChange() {
        fireEvent(new UploadField2.ReadOnlyStatusChangeEvent(this));
    }
